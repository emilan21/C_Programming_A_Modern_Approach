...
/*         looks up the part in the datebase. If the part */
...
void update(void)
{
    ...
    printf("To update the quantity type (c), to update the price type (p)\n");
    scanf(" %c", &to_update);
    if (to_update == 'c') {
        printf("Enter part number: ");
        scanf("%d", &number);
...
/*        showing the part number, part name,            */
